...
static class Util {
  ...
  public static List<K> MapToList<T, K>(this IList<T> array,
                                        Func<T, K> projection) {
  ...
  public static T MaxBy<T, K>(this IEnumerable<T> list, Func<T, K> comparable)
  ...
  Transpose<T>(this IEnumerable<IEnumerable<T>> source) {
  ...
  public static void Set(this ref Transform t, double m00, double m01,
                         double m02, double m03, double m10, double m11,
                         double m12, double m13, double m20, double m21,
  ...
  public static void SetRotation(this ref Transform t, double m00, double m01,
  ...
  // adapted from System.Numerics.Vectors
  public static Quaternion Slerp(ref Quaternion q1, ref Quaternion q2,
                                 double t) {
    ...
    if (cosOmega > (1.0 - epsilon)) {
      ...
      s2 =
          (flip) ? -Sin(t * omega) * invSinOmega : Sin(t * omega) * invSinOmega;
    }
